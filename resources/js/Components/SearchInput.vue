<template>
    <div class="relative">
        <input
            ...
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-orange-500 focus:border-orange-500"
        >
